...
interface MatchingRowProps {
  ...
  /** Ответ зафиксирован: фишка в слоте не перетаскивается. */
  locked?: boolean
}

/** Строка доски: термин + слот-дроп-зона с фишкой или плейсхолдером. */
export function MatchingRow({ pair, held, state, dragPairId, locked }: MatchingRowProps) {
